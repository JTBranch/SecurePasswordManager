// Package e2e provides UI-specific test data and utilities for end-to-end testing
package e2e
		...
		CreateSecret: WorkflowTestData{
			...
			Steps: []WorkflowStep{
				...
				},
				{
					Action:      "type",
					Target:      "name_field",
					Input:       "TestSecret", // Will be replaced with actual test data
				...
				},
				{
					Action:      "type",
					Target:      "value_field",
					Input:       "TestValue", // Will be replaced with actual test data
					Expected:    "text_entered",
		...
		EditSecret: WorkflowTestData{
			...
			Steps: []WorkflowStep{
				...
				},
				{
					...
					Target:      "value_field",
					Input:       "UpdatedValue", // Will be replaced with actual test data
